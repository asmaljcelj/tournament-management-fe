...
export class ProductService {
    ...
    saveHotel(hotel: Hotel) {
        console.log(hotel);
        if (hotel.id) {
            return this.dataService.editHotel(hotel);
        } else {
            return this.dataService.createHotel(hotel);
        }
    }

    deleteHotel(hotel: Hotel): Observable<any> {
        return this.dataService.deleteHotel(hotel);
    }
    
    getProductsData() {
        //console.log(this.dataService.getHotels().subscribe({
        //    next: (data) => console.log(data),
        //    error: (err) => console.error('Api error', err)
        //}));
        return this.dataService.getHotels();
        //return [
        //    {
        //        id: '1000',
        //        code: 'f230fh0g3',
